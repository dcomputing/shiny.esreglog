...
Basically, all there is to know about *R6* system in regards to *shiny.esreglog*
usage is, that:

- all modules available in *shiny.esreglog* are *R6* classes:
  - *RegLogServer*
...
ShinyApp that incorporates *shiny.esreglog* should be using to profit from user
