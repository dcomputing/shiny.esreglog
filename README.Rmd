...
[![CRAN status](https://www.r-pkg.org/badges/version/shiny.esreglog)](https://CRAN.R-project.org/package=shiny.esreglog)
[![CRAN checks](https://cranchecks.info/badges/worst/shiny.esreglog)](https://cranchecks.info/pkgs/shiny.esreglog)
...
[![Codecov test coverage](https://codecov.io/gh/StatisMike/shiny.esreglog/branch/master/graph/badge.svg)](https://app.codecov.io/gh/StatisMike/shiny.esreglog?branch=master)
...
*shiny.esreglog* supports as data containers either databases accessed with
...
password. *shiny.esreglog* supports two methods of email sending: via `emayili`
...
Basic information about *shiny.esreglog* is contained within this document. There
