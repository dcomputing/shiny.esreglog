...
RegLog_txts$en = list(
  ...
  reset_ui_2 = "To reset your password, type in your username and press the 'Send code' button. The code to reset your password will be sent to the e-mail that you provided during registration.",
  ...
  reset_ui_4 = "Validation code",
  reset_bttn_1 = "Send code",
  reset_bttn_2 = "Confirm code",
  reset_bttn_3 = "Change password",
  ### register module specific labels ####
  register_ui_1 = "Registration form",
  register_ui_2 = "To register, choose a username and provide a valid email adress",
  ...
  login_badId_t = "Username not found",
  login_badId_b = "If the account was registered before, please check if the username was typed correcty. If you haven't registered yet, please register a new account.",
  ...
  register_noInput_b = "To register, please provided all needed data: chosen username, email and password.",
  register_nonValidId_t = "Username non-valid",
  register_nonValidId_b = "Username is not valid. Username must consist of 8~30 aphanumeric characters.",
  ...
  register_existingId_t = "Username non-unique",
  register_existingId_b = "There is an user with that ID in our database. If you have already made an account, try to log in or reset your password. If you haven't, then please use another username.",
  ...
  credsEdit_noInput_other_b = "To change your username and/or email, please provide your current password alongside new username and/or email.",
  credsEdit_badId_t = "Username not found",
  credsEdit_badId_b = "Provided current username isn't found in our database",
  ...
  credsEdit_nonValidId_t = "Username non-valid",
  credsEdit_nonValidId_b = "Provided new username isn't valid. Username must consist of 8~30 alphanumeric characters.",
  ...
  credsEdit_existingId_t = "Username non-unique",
  credsEdit_existingId_b = "The provided new username already exists in our database. Please try another username.",
  ...
  resetPass_noInput_generate_b = "To generate new reset code and have it send to your e-mail please provide your username",
  resetPass_noInput_confirm_t = "Missing data",
  resetPass_noInput_confirm_b = "To reset password with received reset code, please provide your username, received code and new password.",
  ...
  resetPass_badId_t = "Username not found",
  resetPass_badId_b = "Provided username isn't found in our database.",
  ...
  resetPass_codeValidated_t = "Code validated",
  resetPass_codeValidated_b = "The code is correct. Please type in your new password twice",
  ...
  reg_mail_2 = "Your username: ",
  reg_mail_3 = "You can always visit our application at: ",
  # credentials edit
  crededit_mail_h = "data edit confirmation",
  crededit_mail_1 = "Credentials data has been changed for user identified by username:",
  # logout
  logout_bttn = "Log-out",
  # creds_edit
  ...
  cred_edit_ui_p_other_change = "Provide new username and/or new email to change them.",
...
RegLog_txts$i18 <- as.list(
  setNames(
    names(shiny.esreglog:::RegLog_txts$en), 
    names(shiny.esreglog:::RegLog_txts$en)))
...
#' structure of all texts generated by 'shiny.esreglog'.
#'
